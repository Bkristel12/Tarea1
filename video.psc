//1. entra: definir variables color ="verde"(asignado); edads=55 (asignado)
//	pro: color="verde" , edads = 55
...
//  sal: mensaje = edadUsuario, años (mensaje)
Funcion edad(0)	
...
//10. entra: definir variables edadm =0(Asignida)
//	pro:  preguntar si edadm >= 18 
//  sal: por el si "Eres mayor de edad" sino  "Eres menor de edad"
